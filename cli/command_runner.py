...
"""
    ...
    async def run_health_check(self, provider_name: str) -> Dict[str, Any]:
        ...
        try:
            health_report['checks']['standard_provider'] = check_provider_health(provider_name, enhanced=False)
        except Exception as e:
            health_report['checks']['standard_provider'] = {'available': False, 'error': str(e)}

        try:
            health_report['checks']['enhanced_v2_provider'] = check_provider_health(provider_name, enhanced=True)
        except Exception as e:
